...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/Flowseal/">weenkom4ik2</a><a href="https://github.com/Flowseal/zapret-discord-youtube">/zov-zapret</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />
## Аудитория
Zov Zapret расчитан на русских пользователей и иногда английских для FPS буста.
## Как использовать
Использовать очень просто. Выбираете файлик ws.bat и запускаете. После запуска возможна ошибка, это нормально так как я не знаю как её пофиксить, просто закройте окно. Если пишет то что zapret уже запущен, то проверьте интернет соединение.
- Использование service.bat:
> Тут описаны доп. функции, другие смотрите ниже
- 11. Credits - Кредиты на проэкты которые причастны к разработке
- 12. FLC - Fast Language Changer позволит вам быстро сменить регион на компьютере. Пока что тестировалось один раз и вряд ли нормально работает. !! ЕСЛИ СБРОСИЛАСЬ КЛАВА ТО СКАЧАЙТЕ В НАСТРОЙКАХ !!
## Безопасность
Данные не собираются и не передаются. Файлы в открытом доступе и каждый может просканировать запрет. 
Сканы на разных сайтах:
- [VirusTotal](https://www.virustotal.com/gui/file/123b01d7bd08c114a4d4c6951432f6033536721d901ce1b5417f8e578f8dc679?nocache=1)
- [Kaspersky](https://opentip.kaspersky.com/123B01D7BD08C114A4D4C6951432F6033536721D901CE1B5417F8E578F8DC679/results?tab=upload)
> [!CAUTION]
...
> [!IMPORTANT]
> ## Кредиты
> Основной Запрет сделан разработчиком Flowseal на чтом ему спасибо! Вот оригинальный [Запрет](https://github.com/Flowseal/zapret-discord-youtube/)
> ## Другая информация
> Проект сделан не для заработка а для работы, и хорошей игры.
> ### FLC
> FLC - мой другой проэкт на Batch но я не сильно им увлекаюсь. Он есть в Зов Запрете в файле **service.bat**

# Zapret README.md
Официальный README от Flowseal.
- ЭТО НОВЫЙ README ТАК ЧТО ТУТ НОВЫЕ ВЕЩИ И ФУНКЦИИ
[Открыть README на оффициальной странице](https://github.com/Flowseal/zapret-discord-youtube/blob/main/README.md)
