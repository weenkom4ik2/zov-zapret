...
## Как использовать
Использовать очень просто. Выбираете файлик ws.bat и запускаете. Если пишет то что zapret уже запущен, то проверьте интернет соединение.
...
## Как скачать
Справа будет плашка Releases нажимаете на последнюю (Latest) и скачиваете Source Code нажав на него.
## Безопасность
